...
export default function Contact() {
  return (
    <section id="contact" className="contact section-frame content-section">
      <div className="contact-image"><img loading="lazy" src="/images/santa-monica-sunset.webp" alt="Santa Monica pier at sunset" /></div>
      <div className="contact-copy"><h2>Let's build<br /><em>something interesting.</em></h2><p>Have a project in mind? Want to collaborate? Or just want to talk AI, games, or the best taco spots in LA?</p><a className="contact-email" href="https://linkedin.com/in/amogh-biju" target="_blank" rel="noreferrer">Start a conversation <ArrowUpRight /></a></div>
